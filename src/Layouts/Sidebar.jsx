...
const Sidebar = () => {
  ...
  return (
    <aside className="bg-white w-64 min-h-screen min-w-[400px] border-r border-green-200">
      ...
      <nav className="mt-2">
            <ul>
                ...
                <li>
                    ...
                    <FontAwesomeIcon icon={faBoxOpen} className="ml-4 mr-8" />
                        Order
                    </a>
                </li>
                <hr size="2"></hr>
